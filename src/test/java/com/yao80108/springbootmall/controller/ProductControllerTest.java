...
public class ProductControllerTest {
    ...
    public void createProduct_success() throws Exception {
        ...
        productResquest.setProductName("test food");
        productResquest.setCategory(ProductCategory.FOOD);
        productResquest.setImageUrl("http://test.com");
        productResquest.setPrice(100);
        productResquest.setStock(2);
        String json = objectMapper.writeValueAsString(productResquest);
        RequestBuilder requestBuilder = MockMvcRequestBuilders
                .post("/products")
